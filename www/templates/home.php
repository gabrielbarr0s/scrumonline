...
<div class="row">
  <article class="col-xs-12 col-lg-10 col-lg-offset-1">
    <p>
      ...
      Welcome to my open source Planning Cards Online app. Use of this app is free of charge for everyone. As a scrum master just start a named session 
      and invite your team to join you. It is recommended to display the scrum master view at <b>https://planningcards.online/</b> with a big screen (TV or projector) and let everyone else 
